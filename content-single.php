...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<header class="entry-header page-header">
		...
		/* Line commented out by Eric Shmookler.  Commmenting out the line below removes the Featured Image from the post template */
	...
	<div class="entry-content">
 	<a href="#comment" class="pp"> Post Comment </a>
		<?php the_content(); ?>
