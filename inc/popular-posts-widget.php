        ...
        <div class="widget tabbed">
            <div class="tabs-wrapper">
                <ul class="nav nav-tabs">                      
                      ...
                      <!--	Popular Posts removed by Eric Shmookler
                      
                      <li><a href="#popular-posts" data-toggle="tab"><?php esc_attr_e( 'Popular', 'dazzling' ); ?></a></li>
            ...
            <div class="tab-content">
                <?php /*?><ul id="popular-posts" class="tab-pane active">
                ...
                </ul><?php */?><ul id="recent" class="tab-pane active">

                    <?php
                    $recent_posts = new WP_Query(array('showposts' => $number,'post_status' => 'publish', 'ignore_sticky_posts' => 1,'order'=> 'DESC' ));
                    ?>
